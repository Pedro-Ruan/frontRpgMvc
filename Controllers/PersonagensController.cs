    ...
    public class PersonagensController : Controller
    {
      public string uriBase = "http://luizsouza.somee.com/RpgApi/Personagens/";
        ...
        public async Task<ActionResult> IndexAsync()
        {
          ...
          //httpClient.DefaultResquestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
        ...
        public async Task<ActionResult> CreateAsync(PersonagemViewModel p)
        {
            try
            {
                ...
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Rearer", token);
